 ...
 * Displays workspace stats, recent executions, quick actions, and workspace list.
 * Uses the DashboardLayout shell with sidebar navigation.
 *
 * @example
 * ```tsx
 * <DashboardPage />
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-4 max-w-md text-center">
          ...
          <Button onClick={() => { setError(null); setLoading(true); setUserLoaded(false); window.location.reload(); }}>
            Retry
          </Button>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        {workspaces.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card
              className="card-hover cursor-pointer border-dashed flex items-center justify-center min-h-[120px]"
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { label: 'Triggers', icon: 'M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z', href: '/triggers' },
      ...
      <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Give your workspace a name and optional slug.</DialogDescription>
          </DialogHeader>
